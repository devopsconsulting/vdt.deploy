...
class ProviderCloudstackTest(TestCase):
    ...
    def test_do_deploy(self):
        ...
        avira.deploy.providers.provider_cloudstack.add_pending_certificate(1113).\
                                                              AndReturn(None)
    ...
    def test_do_destroy_no_exists(self):
        ...
        self.mock_client.listVirtualMachines({'domainid': '1'}).\
                        AndReturn(testdata.listVirtualMachines_output)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "find_machine")
        avira.deploy.providers.provider_cloudstack.find_machine('1114',
    ...
    def test_do_destroy_puppetmaster(self):
        ...
        self.mock_client.listVirtualMachines({'domainid': '1'}).\
                        AndReturn(testdata.listVirtualMachines_output)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "find_machine")
        avira.deploy.providers.provider_cloudstack.find_machine(machine.id,
                                       testdata.listVirtualMachines_output).\
                                       AndReturn(machine)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "is_puppetmaster")
        avira.deploy.providers.provider_cloudstack.is_puppetmaster(machine.id).AndReturn(True)
    ...
    def test_do_destroy(self):
        ...
        avira.deploy.providers.provider_cloudstack.find_machine(machine.id,
                                       ...
                                       AndReturn(machine)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "is_puppetmaster")
        avira.deploy.providers.provider_cloudstack.is_puppetmaster(machine.id).AndReturn(False)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "run_machine_cleanup")
        avira.deploy.providers.provider_cloudstack.run_machine_cleanup(machine).\
        ...
        avira.deploy.providers.provider_cloudstack.remove_machine_port_forwards(machine,
                    self.mock_client).\
                    AndReturn(testdata.remove_machine_port_forwards_output())
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "node_clean")
        avira.deploy.providers.provider_cloudstack.node_clean(machine).\
                                        AndReturn(testdata.node_clean_output())
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "clean_foreman")
    ...
    def test_do_start(self):
        ...
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "find_machine")
        avira.deploy.providers.provider_cloudstack.find_machine('1112',
                                       testdata.listVirtualMachines_output).\
                                       AndReturn(machine)
    ...
    def test_do_stop(self):
        ...
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "find_machine")
        avira.deploy.providers.provider_cloudstack.find_machine('1111',
                                       testdata.listVirtualMachines_output).\
                                       AndReturn(machine)
    ...
    def test_do_reboot_not_found(self):
        ...
        self.mock_client.listVirtualMachines({'domainid': '1'}).\
                        AndReturn(testdata.listVirtualMachines_output)
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "find_machine")
        avira.deploy.providers.provider_cloudstack.find_machine('1113',
                                       testdata.listVirtualMachines_output).\
                                       AndReturn(None)
    ...
    def test_kick_role(self):
        ...
        self.mox.StubOutWithMock(avira.deploy.providers.provider_cloudstack, "subprocess")
        avira.deploy.providers.provider_cloudstack.subprocess.check_output(KICK_CMD,
    ...
    def test_mco(self):
        ...
        avira.deploy.providers.provider_cloudstack.check_call_with_timeout(['mco'], 5).\
