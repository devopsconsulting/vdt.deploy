...
if not os.path.isfile(configfile):
    ...
    config.set('deployment', 'cloudinit_puppet', 'http://vdt.avira-cloud.net/autodeploy/vdt-puppet-agent.cloudinit')
    config.set('deployment', 'cloudinit_base', 'http://vdt.avira-cloud.net/autodeploy/vdt-base.cloudinit')
