...
if not os.path.isfile(configfile):
    ...
    config.set('signbot', 'puppet_binary', '/usr/bin/puppet')
    config.set('signbot', 'puppet_cert_directory', '/var/lib/puppet/')
    config.set('signbot', 'cert_req', '/var/lib/puppet/cert_req.txt')
...
PUPPET_BINARY = config.get('signbot', 'puppet_binary')
PUPPET_CERT_DIRECTORY = config.get('signbot', 'puppet_cert_directory')
CERT_REQ = config.get('signbot', 'cert_req')
